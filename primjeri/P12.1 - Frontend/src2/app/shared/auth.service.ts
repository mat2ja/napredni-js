...
export class AuthService {
  ...
  login(credentials : {username : string, password: string}){
    ...
    let users = [
      {id:1, username:'oggy',password:'1234', email:'test@test', name:'Ognjen Staničić', role:1},
      {id:2, username:'oggy2',password:'1234', email:'test@test', name:'Ognjen Staničić', role:2}
    ];
